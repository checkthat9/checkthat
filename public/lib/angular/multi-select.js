...
(function() {
    angular.module('multipleSelect').directive('multipleAutocomplete', ['$filter', '$http', function($filter, $http) {
        return {
            restrict: 'EA',
            scope: {
                suggestionsArr: '=',
            ...
            link: function(scope, element, attr) {
                ...
                scope.onFocus = function() {
                    ...
                    $("#nestedAccordionB").css("height", "150px");
                };
                ...
                scope.onBlur = function() {
                    scope.isFocused = false;
                    $("#nestedAccordionB").css("height", "60px");
                };
